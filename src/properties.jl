...
# function tps(wave_function::WaveFunction, topology::Topology, MOenergies)
function tps(H::Hamiltonian, energies::AbstractVector{Float64}, states::AbstractMatrix{Float64})
